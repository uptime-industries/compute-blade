...
The Compute Blade features a Support for PoE (`802.3af`), PoE+(`802.3at`), and PoE++(`802.3bt`).
...
On the Compute Blade `GPIO23` is used to indiacate the presance of PoE+ or PoE++. This could be used modify the behavor of the blade depending to the supllied power.
...
<img src='/img/blade/mk4-k-poe-plus.png' alt='Compute Blade with PoE+ light identified' width={'50%'}/>
...
<Tabs groupId='code-lang'>
    ...
    try:
        ...
        if button_state == True:
            ...
            print("Powersource: PoE or USB-C")
    except:
        GPIO.cleanup()
    ```
    </TabItem>
    ...
    int main(void) {
        ...
        if (poeIndicatorState == HIGH) {
            printf("Powersource: PoE or USB-C\n");
        } else {
