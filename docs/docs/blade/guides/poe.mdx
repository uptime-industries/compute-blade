...
During Testing a Compute Blade with a CM4 overclocked to 2GHz and a consumer NVMe SSD under load consumes ~7W. Normal operation may range from 3W to 17W depending on work load.
