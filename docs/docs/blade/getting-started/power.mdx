...
The only way to power the Compute Blades is with Power over Ethernet plus(PoE+). The exception to this is DEV model Blades which in additional have USB Type-C port that can be used to deliver power.
...
:::
:::tip
If you are Using a BladeRUnner enclosure only PoE is a support power option
:::

:::note
For more information on PoE see out our dedicated [PoE page](/blade/guide/poe)
:::
