...
<img src="/img/blade/connect.webp" width={'70%'}/>
...
The USB Type-C port does not provided network connectivity. Use an Ethernet cable to connect the blade to your network.
