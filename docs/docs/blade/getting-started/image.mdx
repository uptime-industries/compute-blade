...
<Tabs groupId="boot" defaultValue="ssd">
    ...
    <TabItem value="emmc" label="eMMC">
        ...
        <Admonition type="note">
            CM4s with part number `CM4XXX000` do **NOT** have eMMC and are referred to a lite
            <img src='/img/cm4-box.png' width="250" alt='CM4 box with model number highlighted'/>
        </Admonition>
...
<Tabs groupId="boot" defaultValue="ssd" queryString="boot">
    <TabItem value="microsd" label="microSD Card" >
        ...
        ![Compute Blade mk4 sd card slot](/img/blade/mk4-k-sd.png)
    </TabItem>
    <TabItem value="ssd" label="SSD">
        ...
        ![Compute Blade mk4 ssd slot](/img/blade/mk4-k-ssd.png)
    </TabItem>
    <TabItem value="emmc" label="eMMC">
        Unplug the USB-C cable from the Compute Blade and set the switch to USB-A

        ![Compute Blade mk4 eMMC chip](/img/blade/mk4-k-emmc.png)
    </TabItem>
</Tabs>
