...
:::note
Preboot eXecution Environment(PXE) is a process to boot a computer over the a network. It will not be covered here. See our [dedicated guide](/blade/advanced-guides/pxe-booting/) for more information
:::
...
- `GENERAL > Set locale setting`(Optional) - this will adjust the blade locale setting 
...
<Tabs groupId="boot" defaultValue="ssd">
    ...
    <TabItem value="ssd" label="SSD">
        ...
        4. Place the plastic washer on to the screw and use a PH1 driver to retain the M.2 SSD
