...
Witch the Latch assembled it can be secured to the blade. Using a PH1 screw driver, take the two M3x6 screws and secure the latch to the blade.
...
To use the slot, screw the included M2x2.5 standoff into the threaded insert corresponding to the size of your M.2 device with a 5mm hex driver.
